...
function BuildingHelper:SetupBuildingTable(abilityName, builderHandle)
    ...
    local builderInside = unitTable["BuilderInside"]
    if builderInside ~= nil then
        buildingTable:SetVal("BuilderInside", string.upper(builderInside))
    end

    local consumesBuilder = unitTable["ConsumesBuilder"]
    if consumesBuilder ~= nil then
        buildingTable:SetVal("ConsumesBuilder", string.upper(consumesBuilder))
    end
...
function BuildingHelper:RemoveBuilding(building, isUpgrade)
...
function BuildingHelper:AddRepairToQueue(builder, building, bQueued)
    ...
    local bResult = self:OnPreRepair(building, builder)
